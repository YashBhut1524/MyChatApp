...
import { GET_ALL_MESSAGES_ROUTE, GET_CHANNEL_MESSAGES_ROUTE, HOST } from "@/utils/constans.js";
            ...
            <div className={`${message.sender === selectedChatData._id ? "text-left" : "text-right"}`}>
                {message.messageType === "text" && (
                        <div
                            ...
                            style={message.sender === userInfo.id 
                                ? {
                                    backgroundColor: userInfo.colors.bgColor,
                                    color: userInfo.colors.textColor,
                                    borderColor: userInfo.colors.borderColor,
                ...
                <div className="text-xs text-white">{moment(message.timestamp).format("LT")}</div>
            </div>
        );
    };
